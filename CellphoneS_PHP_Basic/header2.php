    ...
    <div class="nav">
        ...
        <div class="cart-bag">
            <a href="addCart.php">
                ...
                <span>Giỏ <br>hàng <span id="cart-counter">0</span></span>
            </a>
        </div>
        ...
        <div class="login">
            ...
            <?php if (isset($_SESSION['role'])): ?>
                <p class="nameUser"><?php echo "Hiii ".$_SESSION['role']. "!" ?></p>
            <?php else:?>
                <p class="nameUser"><?php echo "Bạn chưa đăng nhập. Hãy đăng nhập để tiếp tục" ?></p>
            <?php endif;?>
        </div> 
    </div>
</nav>
